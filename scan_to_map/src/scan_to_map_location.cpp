...
Scan2MapLocation::Scan2MapLocation() : private_node_("~"), tf_listener_(tfBuffer_)
{
    ...
    odom_subscriber_ = node_handle_.subscribe("/camera_init", 20, &Scan2MapLocation::OdomCallback,
                                                 this,  ros::TransportHints().tcpNoDelay());
...
void Scan2MapLocation::InitParams()
{
    ...
    private_node_.param<std::string>("odom_frame", odom_frame_, "/camera_init");
    private_node_.param<std::string>("base_frame", base_frame_, "/body");
 ...
 * Odom回调函数
 */
void Scan2MapLocation::
OdomCallback(const nav_msgs::Odometry::ConstPtr &odometry_msg)
{
...
bool Scan2MapLocation::ReLocationWithICP(Eigen::Isometry3d &trans ,const sensor_msgs::LaserScan::ConstPtr &scan_msg, PointCloudT::Ptr &cloud_map_msg, const Eigen::Isometry3d &robot_pose)
{
    ...
    if (save_pcd_){
        ...
        std::string scan_cloud_filename = std::string("/home/rm/nqy/sentry/rm2023_auto_sentry_ws-main/src/scan_to_map/bagfiles/scan_cloud_") + buffer + ".pcd";
        std::string map_cloud_filename = std::string("/home/rm/nqy/sentry/rm2023_auto_sentry_ws-main/src/scan_to_map/bagfiles/scan_cloud_/map_cloud_") + buffer + ".pcd";
